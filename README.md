...
| **[HereNow](https://github.com/midlaj-kp/HereNow)**   |A secure, time-bound attendance and live monitoring system that eliminates proxies using localized IoT gateways. |
---
